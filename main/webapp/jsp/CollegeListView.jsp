<%@page import="com.ncs.Model.CollegeModel"%>
<%@page import="com.ncs.beans.CollegeBean"%>
<%@page import="com.ncs.controller.CollegeListCtl"%>
<%@page import="com.ncs.controller.CourseListCtl"%>
				...
				<tr>
					<td align="center"><label> College Name :</label>
					 ...
					 <%=HTMLUtility.getList("collegeid", String.valueOf(bean.getId()), clist)%>
						...
						placeholder="Enter City Name" Size="25"
